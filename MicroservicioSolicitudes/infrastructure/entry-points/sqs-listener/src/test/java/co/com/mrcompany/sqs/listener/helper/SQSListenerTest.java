package co.com.mrcompany.sqs.listener.helper;

import co.com.mrcompany.sqs.listener.SQSProcessor;
import co.com.mrcompany.sqs.listener.config.SQSProperties;
...
class SQSListenerTest {
    ...
    @Mock
    private ILoanApplicationUseCase useCase;
